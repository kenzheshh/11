          ...
          >
            <div className="px-6 pt-4 pb-8 space-y-4">
              ...
              <div className="pt-6 flex flex-col gap-4 border-t border-white/10">
                ...
                <button onClick={() => window.dispatchEvent(new CustomEvent('open-amo-modal'))} className="w-full text-center bg-emerald-500 text-white py-3 rounded-xl text-base font-bold shadow-[0_0_20px_rgba(16,185,129,0.3)]">Попробовать бесплатно</button>
              </div>
            </div>
          </motion.div>
        )}
